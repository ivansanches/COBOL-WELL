       ...
       PROGRAM-ID. RELATORIOV4.
      *=================================================================
      * PROGRAMA    : RELATORIOV4
      * PROGRAMADOR : WELLINGTON SOARES CORDEIRO
      * ANALISTA    : IVAN SANCHES
      * CONSULTORIA : FOURSYS
      * DATA........: 01 / 08 / 2024
      *-----------------------------------------------------------------
      * OBJETIVO....: GRAVACAO DE RELATORIO NO ARQUIVO RELAT.txt
      *
      *-----------------------------------------------------------------
...
ALT2       05 WRK-PAG                  PIC 9(003) VALUE 1.
       ...
       01  WRK-CABEC4.
           ...
           "VALOR TOTAL DA PAGINA:".
           05 WRK-ASSI-ED              PIC ZZ9,99.

       01  WRK-CABEC5.
           05 FILLER                   PIC X(053) VALUE
           "VALOR TOTAL DO RELATORIO:".
           05 WRK-VALOR-TOTAL-ED       PIC ZZ9,99.
      ...
      *-----------------------------------------------------------------
       01  WRK-ASSIS                   PIC 9(003)V99 COMP-3 VALUE ZEROS.
...
ALT2   01  WRK-PAG-AUX                 PIC 9(003) COMP-3   VALUE 1.
      ...
      *-----------------------------------------------------------------
       01  WRK-VALOR-TOTAL             PIC 9(003)V99      VALUE ZEROS.
      *-----------------------------------------------------------------
...
ALT3  *         WRITE REG-RELAT AFTER PAGE.
...
ALT2       ADD 1 TO ACU-QTD-LIDOS
           ...
           IF WRK-QT-LINHAS GREATER THAN 8
